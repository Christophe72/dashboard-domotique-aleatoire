  ...
  return (
    <aside className="glass-panel flex w-full flex-col gap-6 rounded-3xl p-6 lg:w-64">
      <div className="flex items-center gap-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-500 via-fuchsia-500 to-indigo-500 shadow-lg">
      ...
      <div className="mt-auto rounded-2xl border border-white/10 bg-white/5 p-4">
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          <span className="rounded-full bg-[var(--success)]/20 px-2 py-1 text-xs text-[var(--success)]">
            99.2%
          </span>
        </div>
